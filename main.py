...
if __name__ == '__main__':
    ...
    for ind in station_data.index:
        if int(station_data['ZIP'][ind]) in d:
            if not station_data['is_na'][ind] and station_data['State'][ind] == 'FL':
    ...
    # num_evs_dict = num_evs()
    # for key in num_evs_dict:
    #     if key not in d:
    #         d[key] = np.zeros(num_stats + 3)
    #     d[key][9] = num_evs_dict[key]
    ...
    edited_data.to_csv('Data/final_data.csv')
    ...
    DCFC_df.to_csv('Data/FL DCFC.csv')
    # L2_df.to_csv('Data/level2final.csv')
    # DCFC_normalized.to_csv('Data/DCFC normalized.csv')
    # DCFC_standardized.to_csv('Data/DCFC standardized.csv')
    # L2_normalized.to_csv('Data/L2 normalized.csv')
    # L2_standardized.to_csv('Data/L2 standardized.csv')
